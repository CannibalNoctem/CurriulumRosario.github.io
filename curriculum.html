            ...
            <div class="row">
                <div class="col-xs-12 col-sm-2 sidebar">
                    <div class="col-sm-2 sidebarWrapper">
                        <!-- Avatar -->
						<img class="user-pic" src="images/perfil2.jpg" alt="">
						<div class="signature">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-9 col-sm-offset-3 aboutWrapper">
							...
							<div class="nav-extra hidden-xs">
								...
								<!-- Button 'Hire me' -->
								<a href="#contact" class="btn btn-info">Contacta conmigo ahora</a>
							</div>
                            <div class="section-title">
                                <h2><span>01</span>Sobre Mi</h2>
							</div><!-- end Section Title -->
							<h1>Hola, soy <strong>Rosario Santos Fernández</strong> <br>Técnica de <span class="bg-color"> Sistemas</span></h1>
							<p>Técnica informática altamente experimentada y capacitada, con una sólida formación técnica. Preparada para desarrollar conceptos técnicos complejos a clientes de forma clara y comprensible. Capacitada para realizar múltiples tareas, tales como instalación y reparación de sistemas informáticos, con total precisión y eficiencia. </p>
							
                            <div class="skills">
                                <!-- Skill 1 -->
                                <div class="skill-outer">
                                    <h4>HTML5 &amp; CSS3<span>80%</span></h4>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-9 col-sm-offset-3 resumeWrapper">
                            ...
                            <div class="resume-box">
                                ...
                                <div>
                                    <h3>TITULACIÓN IES MAESTRO ELOY VAQUERO</h3>
                                    <span>2015 - 2020</span>
                                    <p>Título de Educación Secundaria Obligatoria</p>
                                </div>
                            </div>
                            <!-- Resume box 2 -->
                            <div class="resume-box">
                                ...
                                <div>
                                    <h3>TITULACIÓN IES PROFESOR TIERNO GALVÁN</h3>
                                    <span>2020 - PRESENTE</span>
                                    <p>Actualmente realizando el curso de formacion profesional Grado Medio de Sistemas Microinformaticos y Redes.</p>
                                </div>
                            </div>
                            <!-- end Resume box 4 -->
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-9 col-sm-offset-3 contactWrapper">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 contact-info">
                                    ...
                                    <ul>
                                        <li>
                                            <h3><span class="icon_pin" aria-hidden="true"></span> Localización</h3>
                                            <p>Plaza Pablo Neruda, 4 Montalbán de Córdoba</p>
                                        </li>
                                        <li>
                                            <h3><span class="icon_phone" aria-hidden="true"></span>Teléfono</h3>
                                            <p>+(34) 674837771</p>
                                        </li>
                                        <li>
                                            <h3><span class="icon_mail" aria-hidden="true"></span> Email</h3>
                                            <p>rosariosantos2014.rsf@gmail.com</p>
                                        </li>
                                    </ul>
									</div>
                                </div>
